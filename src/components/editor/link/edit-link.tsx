...
const EditLink: FC<Props> = ({ editor }) => {
  ...
  return (
    ...
    >
      ...
      />
      {!showEditForm && (
        <div className="z-50 flex items-center space-x-6 rounded bg-white p-3 text-primary-900 shadow-md shadow-primary-200 dark:bg-primary-900 dark:text-primary-100">
